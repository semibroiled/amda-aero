% SKRIPT zur automatischen Bestimmung der Mittelwerte (über Iterationen) einer Aero-Datenbank
clear;
...
%Bestimme Mittelwert über letzten x Iterationen und bestimme deren Standardabweichung
